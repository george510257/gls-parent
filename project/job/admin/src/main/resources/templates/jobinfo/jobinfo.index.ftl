                        ...
                        <select class="form-control" id="jobGroupModel">
                            <#list JobGroupList as group>
                                <option value="${group.id}"
                                        <#if jobGroupModel==group.id>selected</#if> >${group.title}</option>
                            </#list>
                        </select>
                    </div>
                </div>
                        ...
                        <div class="box-body">
                            <table id="job_list" class="table table-bordered table-striped" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th name="jobGroupModel">${I18n.job_info_field_jobgroup}</th>
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control" name="jobGroupModel">
                                <#list JobGroupList as group>
                                    <option value="${group.id}"
                                            <#if jobGroupModel==group.id>selected</#if> >${group.title}</option>
                                </#list>
...
#!/usr/bin/env node
console.log("gls-job: hello nodejs")
...
Write-Host "gls-job: hello powershell"
