    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-2">
                    <div class="input-group">
                        ...
                        <select class="form-control" id="jobGroupEntity"
                                paramVal="<#if jobInfoEntity?exists>${jobInfoEntity.jobGroupEntity}</#if>">
                            <#if Request["GLS_JOB_LOGIN_IDENTITY"].role == 1>
                                <option value="0">${I18n.system_all}</option>  <#-- 仅管理员支持查询全部；普通用户仅支持查询有权限的 jobGroupEntity -->
                            </#if>
                ...
                <div class="col-xs-1">
                    <button class="btn btn-block btn-default" id="clearLog">${I18n.job_log_clean}</button>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table id="job_log_list" class="table table-bordered table-striped display" width="100%">
                                <thead>
                                <tr>
                                    <th name="jobId">${I18n.job_info_field_id}</th>
                                    <th name="jobGroupEntity">jobGroupEntity</th>
                ...
                <form class="form-horizontal form" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="hidden" name="jobGroupEntity">
                        </div>
                    </div>
