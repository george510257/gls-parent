...
@Entity
@Table(name = "tb_spot_check_distribute", schema = "ai_quality_check", catalog = "")
public class SpotCheckDistributeEntity {
    private Integer id;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (distributeRate != null ? distributeRate.hashCode() : 0);
    ...
    public boolean equals(Object o) {
        ...
        SpotCheckDistributeEntity that = (SpotCheckDistributeEntity) o;
        if (id != null ? !id.equals(that.id) : that.id != null) return false;
        if (spotCheckId != null ? !spotCheckId.equals(that.spotCheckId) : that.spotCheckId != null) return false;
        if (userId != null ? !userId.equals(that.userId) : that.userId != null) return false;
        if (distributeRate != null ? !distributeRate.equals(that.distributeRate) : that.distributeRate != null)
            return false;
