...
@Entity
@Table(name = "tb_result_text_split_word_customer", schema = "ai_quality_check", catalog = "")
public class ResultTextSplitWordCustomerEntity {
    private Integer id;
    ...
    public boolean equals(Object o) {
        ...
        ResultTextSplitWordCustomerEntity that = (ResultTextSplitWordCustomerEntity) o;
